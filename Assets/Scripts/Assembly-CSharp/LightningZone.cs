...
public class LightningZone : SkillBehaviour
{
	[Serializable]
	...
	private sealed class _003CCountDown_003Ed__17 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		public LightningZone _003C_003E4__this;
	...
	[SerializeField]
	private List<ZoneModel> allLightningZones;
	...
	public static LightningZone Instance { get; private set; }
