...
public class FireZone : SkillBehaviour
{
	[Serializable]
	...
	private sealed class _003CCountDown_003Ed__17 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		public FireZone _003C_003E4__this;
	...
	[SerializeField]
	private List<ZoneModel> allFireZones;
	...
	public static FireZone Instance { get; private set; }
