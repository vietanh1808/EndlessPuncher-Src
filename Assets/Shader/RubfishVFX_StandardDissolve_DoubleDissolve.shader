Shader "RubfishVFX/StandardDissolve_DoubleDissolve" {
	Properties {
		_MainColor ("MainColor", Vector) = (1,1,1,0)
		_HighColor ("HighColor", Vector) = (1,1,1,0)
		...
		_Tab_MinMax_0_1 ("Dissolve_ColorRemap", Vector) = (0,0,0,0)
		_SoftParticle ("SoftParticle", Range(0, 5)) = 0
		[ToggleUI] _CustomPanning ("CustomPanning", Float) = 0
