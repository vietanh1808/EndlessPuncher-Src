Shader "RubfishVFX/Transparencies_Gradient_Noise_Add" {
	Properties {
		...
		_PreNoiseLerp ("PreNoiseLerp", Float) = 0
		_NoiseHighColor ("NoiseHighColor", Vector) = (1,1,1,1)
		_NoiseLowColor ("NoiseLowColor", Vector) = (0,0,0,0)
