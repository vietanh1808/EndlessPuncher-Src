Shader "RubfishVFX/StandardTransparencyShaderFresnel" {
	Properties {
		...
		_FresnelIntensity ("FresnelIntensity", Range(0, 3)) = 1
		_FresnelLow ("FresnelLow", Vector) = (0,0,0,0)
		_FresnelHigh ("FresnelHigh", Vector) = (1,1,1,0)
		[ToggleUI] _UseFresnelAlpha ("UseFresnelAlpha?", Float) = 0
		[ToggleUI] _InvertFresnelAlpha ("InvertFresnelAlpha?", Float) = 0
		_FresnelAlpha_Intensity ("FresnelAlpha_Intensity", Range(0, 3)) = 1
