Shader "RubfishVFX/Transparencies_Gradient_Noise_AddCustomGradients" {
	Properties {
		_MainColor ("MainColor", Vector) = (1,1,1,0)
		[ToggleUI] _UserLerp ("UserLerp?", Float) = 0
		_PreLerp ("PreLerp", Float) = 1
		...
		[NoScaleOffset] _SoftParticle_Texture ("SoftParticle_Texture", 2D) = "white" {}
		_SoftParticle_Lerp ("SoftParticle_Lerp", Range(0, 1)) = 0
		_SoftParticle_Speed ("SoftParticle_Speed", Vector) = (0,0,0,0)
		_SoftParticle_Tiling ("SoftParticle_Tiling", Vector) = (0,0,0,0)
		_SoftParticle_Step ("SoftParticle_Step", Vector) = (0,0,0,0)
		...
		[NoScaleOffset] _NoiseTexture_Opacity ("NoiseTexture_Opacity", 2D) = "white" {}
