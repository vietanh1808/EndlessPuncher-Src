Shader "Shader Graphs/RefractionShader" {
	Properties {
		...
		_TilingOffsetData ("TilingOffsetData", Vector) = (0,0,0,0)
		_NormalPower ("NormalPower", Float) = 0
		_RefractionPower ("RefractionPower", Float) = 0
		_DistortTexturePanning ("DistortTexturePanning", Vector) = (0,0,0,0)
		_OpacityTexturePanning ("OpacityTexturePanning", Vector) = (0,0,0,0)
